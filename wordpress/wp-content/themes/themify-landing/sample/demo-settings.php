...
$widgets = get_option( "widget_mc4wp_widget" );
$widgets[1007] = array (
  'title' => 'Newsletter',
);
update_option( "widget_mc4wp_widget", $widgets );
